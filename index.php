			...
			<div class="contact-form">
				<div class="formulier">
					<form method="post" action="">
						<input type="text" class="user" name = "user" value="<?php if(isset($gebruiker)) { echo filter_var($gebruiker, FILTER_SANITIZE_SPECIAL_CHARS); }?>"onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Gebruikersnaam';}" />
