			        	...
			        	<table class="table table-condensed table-bordered">
						    ...
						    <tbody>					    	
						    	<tr class="inputrow">
						            ...
						            <td style="display: none;"><input type="hidden" name="gebruiker_id" value="<?php echo $leerling["gebruiker_id"] ?>"></td>	
			            		</tr>
							</tbody>
						</table>
					</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
            	<form action="" method="POST">
                    ...
                    <input type="hidden" name="gebruiker_id" value="<?php echo $leerling["gebruiker_id"] ?>"></td>
